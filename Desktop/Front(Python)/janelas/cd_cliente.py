...
class cdCliente:
    ...
    def __init__(self,callback, dados=None,editar=None):
        ...
        titulo = ("Consultar Cliente" if editar == 1 else "Cadastrar Cliente")
    ...
    def elementos_tela(self, root):
        ...
        if self.editar != 0 :
            ...
            btn_registrar = ctk.CTkButton(root, width=300, height=35, text='Registrar', command=lambda: self.modificacao_cliente(
